MATLAB demo code of Blur Measurement for Partially Blurred Image with Saliency Constrained Global Refinement

This software demos the algorithm in our paper published in PCM 2018. Please 'demo.m' for more details.

********************************************************************************************************************************
If you use this code and its associated data (e.g. images) in your publication, please cite the following paper. Thanks:
